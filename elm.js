...
Elm.List.Nonempty.make = function (_elm) {
   ...
   var sample = F2(function (seed,nonempty) {
      var gen = A2($Random.$int,0,length(nonempty) - 1);
      var _p18 = A2($Random.generate,gen,seed);
      var i = _p18._0;
      var seed2 = _p18._1;
      return {ctor: "_Tuple2",_0: A2(get,i,nonempty),_1: seed2};
   });
   var toList = function (_p19) {    var _p20 = _p19;return A2($List._op["::"],_p20._0,_p20._1);};
   var tail = function (_p21) {    var _p22 = _p21;return _p22._1;};
   var head = function (_p23) {    var _p24 = _p23;return _p24._0;};
   ...
   var fromList = function (ys) {
      var _p25 = ys;
      if (_p25.ctor === "::") {
            return $Maybe.Just(A2(Nonempty,_p25._0,_p25._1));
         } else {
            return $Maybe.Nothing;
         }
   };
   var cons = F2(function (y,_p26) {    var _p27 = _p26;return A2(Nonempty,y,A2($List._op["::"],_p27._0,_p27._1));});
   _op[":::"] = cons;
   var append = F2(function (_p29,_p28) {
      var _p30 = _p29;
      var _p31 = _p28;
      return A2(Nonempty,_p30._0,A2($Basics._op["++"],_p30._1,A2($List._op["::"],_p31._0,_p31._1)));
   });
   var pop = function (_p32) {
      var _p33 = _p32;
      var _p35 = _p33._1;
      var _p34 = _p35;
      if (_p34.ctor === "[]") {
            return A2(Nonempty,_p33._0,_p35);
         } else {
            return A2(Nonempty,_p34._0,_p34._1);
         }
   };
   var reverse = function (_p36) {
      var _p37 = _p36;
      var revapp = function (_p38) {
         revapp: while (true) {
            var _p39 = _p38;
            var _p42 = _p39._0;
            var _p41 = _p39._1;
            var _p40 = _p39._2;
            if (_p40.ctor === "[]") {
                  return A2(Nonempty,_p41,_p42);
               } else {
                  var _v23 = {ctor: "_Tuple3",_0: A2($List._op["::"],_p41,_p42),_1: _p40._0,_2: _p40._1};
                  _p38 = _v23;
                  continue revapp;
               }
         }
      };
      return revapp({ctor: "_Tuple3",_0: _U.list([]),_1: _p37._0,_2: _p37._1});
   };
   var concat = function (_p43) {
      var _p44 = _p43;
      var _p45 = _p44._0;
      var tl = A2($Basics._op["++"],tail(_p45),$List.concat(A2($List.map,toList,_p44._1)));
      var hd = head(_p45);
      return A2(Nonempty,hd,tl);
   };
   var replaceHead = F2(function (y,_p46) {    var _p47 = _p46;return A2(Nonempty,y,_p47._1);});
   var replaceTail = F2(function (ys,_p48) {    var _p49 = _p48;return A2(Nonempty,_p49._0,ys);});
   var dropTail = function (_p50) {    var _p51 = _p50;return A2(Nonempty,_p51._0,_U.list([]));};
   var map = F2(function (f,_p52) {    var _p53 = _p52;return A2(Nonempty,f(_p53._0),A2($List.map,f,_p53._1));});
   var concatMap = F2(function (f,xs) {    return concat(A2(map,f,xs));});
   var map2 = F3(function (f,_p55,_p54) {    var _p56 = _p55;var _p57 = _p54;return A2(Nonempty,A2(f,_p56._0,_p57._0),A3($List.map2,f,_p56._1,_p57._1));});
   var andMap = map2(F2(function (x,y) {    return x(y);}));
   var indexedMap = F2(function (f,_p58) {
      var _p59 = _p58;
      var wrapped = F2(function (i,d) {    return A2(f,i + 1,d);});
      return A2(Nonempty,A2(f,0,_p59._0),A2($List.indexedMap,wrapped,_p59._1));
   });
   var filter = F3(function (p,d,_p60) {
      var _p61 = _p60;
      var _p64 = _p61._1;
      var _p63 = _p61._0;
      if (p(_p63)) return A2(Nonempty,_p63,A2($List.filter,p,_p64)); else {
            var _p62 = A2($List.filter,p,_p64);
            if (_p62.ctor === "[]") {
                  return A2(Nonempty,d,_U.list([]));
               } else {
                  return A2(Nonempty,_p62._0,_p62._1);
               }
         }
   });
   var sort = function (_p65) {
      var _p66 = _p65;
      var _p67 = $List.sort(A2($List._op["::"],_p66._0,_p66._1));
      if (_p67.ctor === "::") {
            return A2(Nonempty,_p67._0,_p67._1);
         } else {
            return _U.crashCase("List.Nonempty",
            {start: {line: 335,column: 3},end: {line: 340,column: 86}},
            _p67)("This can\'t happen: sorting a nonempty list returned an empty list");
         }
   };
   var sortBy = F2(function (f,_p69) {
      var _p70 = _p69;
      var _p71 = A2($List.sortBy,f,A2($List._op["::"],_p70._0,_p70._1));
      if (_p71.ctor === "::") {
            return A2(Nonempty,_p71._0,_p71._1);
         } else {
            return _U.crashCase("List.Nonempty",
            {start: {line: 347,column: 3},end: {line: 352,column: 88}},
            _p71)("This can\'t happen: sortBying a nonempty list returned an empty list");
         }
   });
   var sortWith = F2(function (f,_p73) {
      var _p74 = _p73;
      var _p75 = A2($List.sortWith,f,A2($List._op["::"],_p74._0,_p74._1));
      if (_p75.ctor === "::") {
            return A2(Nonempty,_p75._0,_p75._1);
         } else {
            return _U.crashCase("List.Nonempty",
            {start: {line: 359,column: 3},end: {line: 364,column: 90}},
            _p75)("This can\'t happen: sortWithing a nonempty list returned an empty list");
         }
   });
   var dedup = function (_p77) {
      var _p78 = _p77;
      var dedupe = F3(function (prev,done,next) {
         dedupe: while (true) {
            ...
            if (_p79.ctor === "[]") {
                  ...
                  var _p80 = _p79._0;
                  if (_U.eq(_p80,prev)) {
                        var _v42 = prev,_v43 = done,_v44 = _p81;
                        prev = _v42;
                        done = _v43;
                        next = _v44;
                        continue dedupe;
                     } else {
                        var _v45 = _p80,_v46 = A2($List._op["::"],prev,done),_v47 = _p81;
                        prev = _v45;
                        done = _v46;
                        next = _v47;
                        continue dedupe;
      ...
      return reverse(A3(dedupe,_p78._0,_U.list([]),_p78._1));
   };
   var uniq = function (_p82) {
      var _p83 = _p82;
      var _p87 = _p83._0;
      var unique = F3(function (seen,done,next) {
         unique: while (true) {
            ...
            if (_p84.ctor === "[]") {
                  ...
                  var _p86 = _p84._1;
                  var _p85 = _p84._0;
                  if (A2($List.member,_p85,seen)) {
                        var _v50 = seen,_v51 = done,_v52 = _p86;
                        seen = _v50;
                        done = _v51;
                        next = _v52;
                        continue unique;
                     } else {
                        var _v53 = A2($List._op["::"],_p85,seen),_v54 = A2(_op[":::"],_p85,done),_v55 = _p86;
                        seen = _v53;
                        done = _v54;
                        next = _v55;
                        continue unique;
      ...
      return reverse(A3(unique,_U.list([_p87]),A2(Nonempty,_p87,_U.list([])),_p83._1));
   };
   var scanl = F3(function (f,b,_p88) {    var _p89 = _p88;return A2(Nonempty,b,A3($List.scanl,f,A2(f,_p89._0,b),_p89._1));});
   var scanl1 = F2(function (f,_p90) {
      var _p91 = _p90;
      var _p93 = _p91._0;
      var _p92 = _p91._1;
      if (_p92.ctor === "[]") {
            return A2(Nonempty,_p93,_U.list([]));
         } else {
            return A2(Nonempty,_p93,A3($List.scanl,f,A2(f,_p92._0,_p93),_p92._1));
         }
   });
...
Elm.Turtle = Elm.Turtle || {};
Elm.Turtle.Core = Elm.Turtle.Core || {};
Elm.Turtle.Core.make = function (_elm) {
   "use strict";
   _elm.Turtle = _elm.Turtle || {};
   _elm.Turtle.Core = _elm.Turtle.Core || {};
   if (_elm.Turtle.Core.values) return _elm.Turtle.Core.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var _op = {};
   var depth = function () {
      var depth$ = function (step) {
         var _p0 = step;
         switch (_p0.ctor)
         {case "Make": return depth(_p0._0) + 1;
            case "Branch": return A2($Basics.max,depth(_p0._0),depth(_p0._1)) + 1;
            default: return 1;}
      };
      return A2($List.foldl,F2(function (step,sum) {    return A2($Basics.max,depth$(step),sum);}),0);
   }();
   var length = function () {
      var length$ = function (step) {
         var _p1 = step;
         switch (_p1.ctor)
         {case "Make": return length(_p1._0);
            case "Branch": return length(_p1._0) + length(_p1._1);
            default: return 1;}
      };
      return A2($List.foldl,F2(function (step,sum) {    return length$(step) + sum;}),0);
   }();
   var AnimateOptions = F3(function (a,b,c) {    return {seed: a,dims: b,clock: c};});
   var DrawOptions = F2(function (a,b) {    return {seed: a,dims: b};});
   var render = F2(function (_p2,figures) {
      var _p3 = _p2;
      return A3($Graphics$Collage.collage,
      _p3._0,
      _p3._1,
      A2($List.map,
      $Basics.uncurry($Graphics$Collage.traced),
      A2($List.map,
      function (fig) {
         return {ctor: "_Tuple2",_0: _U.update($Graphics$Collage.defaultLine,{color: fig.color}),_1: $Graphics$Collage.path($List$Nonempty.toList(fig.path))};
      },
      $List$Nonempty.toList(figures))));
   });
   var newFigure = function (state) {
      var oldFigure = $List$Nonempty.head(state.figures);
      var newFigure = _U.update(oldFigure,{path: $List$Nonempty.dropTail(oldFigure.path)});
      return _U.update(state,{figures: A2($List$Nonempty._op[":::"],newFigure,state.figures)});
   };
   var changeFigure = F2(function (state,f) {
      changeFigure: while (true) if ($List$Nonempty.isSingleton($List$Nonempty.head(state.figures).path)) return _U.update(state,
         {figures: A2($List$Nonempty.replaceHead,f($List$Nonempty.head(state.figures)),state.figures)}); else {
            var _v3 = newFigure(state),_v4 = f;
            state = _v3;
            f = _v4;
            continue changeFigure;
         }
   });
   var moveTo = F2(function (state,pos) {
      if ($Basics.not(state.penDown)) return A2(changeFigure,state,function (fig) {    return _U.update(fig,{path: $List$Nonempty.fromElement(pos)});}); else {
            var oldFigure = $List$Nonempty.head(state.figures);
            var newFigure = _U.update(oldFigure,{path: A2($List$Nonempty._op[":::"],pos,oldFigure.path)});
            return _U.update(state,{figures: A2($List$Nonempty.replaceHead,newFigure,state.figures)});
         }
   });
   var seed = $Random.initialSeed(628318530718);
   var defaultDrawOptions = A2(DrawOptions,seed,{ctor: "_Tuple2",_0: 1000,_1: 1000});
   var defaultAnimateOptions = A3(AnimateOptions,seed,$Window.dimensions,A2($Signal.map,$Basics.always({ctor: "_Tuple0"}),$Time.fps(5)));
   var State = F5(function (a,b,c,d,e) {    return {theta: a,scale: b,penDown: c,seed: d,figures: e};});
   var Figure = F2(function (a,b) {    return {color: a,path: b};});
   var state0 = function (seed) {
      return A5(State,
      $Basics.degrees(90),
      1,
      true,
      seed,
      $List$Nonempty.fromElement(A2(Figure,$Color.black,$List$Nonempty.fromElement({ctor: "_Tuple2",_0: 0,_1: 0}))));
   };
   var RotateTo = function (a) {    return {ctor: "RotateTo",_0: a};};
   var Teleport = function (a) {    return {ctor: "Teleport",_0: a};};
   var Randomly = function (a) {    return {ctor: "Randomly",_0: a};};
   var PenDown = {ctor: "PenDown"};
   var PenUp = {ctor: "PenUp"};
   var Pen = function (a) {    return {ctor: "Pen",_0: a};};
   var Stay = {ctor: "Stay"};
   var Scale = function (a) {    return {ctor: "Scale",_0: a};};
   var Atomically = function (a) {    return {ctor: "Atomically",_0: a};};
   var Branch = F2(function (a,b) {    return {ctor: "Branch",_0: a,_1: b};});
   var Make = function (a) {    return {ctor: "Make",_0: a};};
   var Left = function (a) {    return {ctor: "Left",_0: a};};
   var Right = function (a) {    return {ctor: "Right",_0: a};};
   var Back = function (a) {    return {ctor: "Back",_0: a};};
   var Forward = function (a) {    return {ctor: "Forward",_0: a};};
   var $eval = F2(function (step,state) {
      $eval: while (true) {
         var _p4 = step;
         switch (_p4.ctor)
         {case "Forward": var _p6 = _p4._0;
              var dy = state.scale * _p6 * $Basics.sin(state.theta);
              var dx = state.scale * _p6 * $Basics.cos(state.theta);
              var _p5 = $List$Nonempty.head($List$Nonempty.head(state.figures).path);
              var x0 = _p5._0;
              var y0 = _p5._1;
              return A2(moveTo,state,{ctor: "_Tuple2",_0: x0 + dx,_1: y0 + dy});
            case "Back": var _v6 = Forward(0 - _p4._0),_v7 = state;
              step = _v6;
              state = _v7;
              continue $eval;
            case "Right": return _U.update(state,{theta: state.theta - $Basics.degrees(_p4._0)});
            case "Left": return _U.update(state,{theta: state.theta + $Basics.degrees(_p4._0)});
            case "Scale": return _U.update(state,{scale: state.scale * _p4._0});
            case "Stay": return state;
            case "Pen": return A2(changeFigure,state,function (fig) {    return _U.update(fig,{color: _p4._0});});
            case "PenUp": return _U.update(state,{penDown: false});
            case "PenDown": return _U.update(state,{penDown: true});
            case "Randomly": var _p7 = _p4._0(state.seed);
              var step$ = _p7._0;
              var seed$ = _p7._1;
              var _v8 = step$,_v9 = _U.update(state,{seed: seed$});
              step = _v8;
              state = _v9;
              continue $eval;
            case "Teleport": return A2(moveTo,state,_p4._0);
            case "RotateTo": return _U.update(state,{theta: $Basics.degrees(_p4._0)});
            case "Make": return A2(evalFold,_p4._0,state);
            case "Atomically": return A2(evalFold,_p4._0,state);
            default: var oldFigure = $List$Nonempty.head(state.figures);
              var blankFigure = _U.update(oldFigure,{path: $List$Nonempty.dropTail(oldFigure.path)});
              var blankState = _U.update(state,{figures: $List$Nonempty.fromElement(blankFigure)});
              var results1 = A2(evalFold,_p4._0,blankState);
              var results2 = A2(evalFold,_p4._1,blankState);
              var newFigures = A2($List$Nonempty.Nonempty,
              oldFigure,
              A2($Basics._op["++"],
              $List$Nonempty.toList(results1.figures),
              A2($Basics._op["++"],$List$Nonempty.toList(results2.figures),$List$Nonempty.tail(state.figures))));
              return _U.update(state,{figures: newFigures});}
      }
   });
   var evalFold = $Basics.flip($List.foldl($eval));
   var draw = F2(function (_p8,m) {    var _p9 = _p8;return A2(render,_p9.dims,A2(evalFold,m,state0(_p9.seed)).figures);});
   var evalScan = F2(function (state,m) {
      var _p10 = m;
      if (_p10.ctor === "[]") {
            return $List$Nonempty.fromElement(state);
         } else {
            var _p13 = _p10._1;
            var _p12 = _p10._0;
            var _p11 = _p12;
            if (_p11.ctor === "Make") {
                  var states = A2(evalScan,state,_p11._0);
                  var state$ = $List$Nonempty.head($List$Nonempty.reverse(states));
                  return A2($List$Nonempty.append,states,A2(evalScan,state$,_p13));
               } else {
                  var state$ = A2($eval,_p12,state);
                  return A2($List$Nonempty._op[":::"],state$,A2(evalScan,state$,_p13));
               }
         }
   });
   var animate = F2(function (_p14,m) {
      var _p15 = _p14;
      var noPath = function (fig) {    return $List$Nonempty.isSingleton(fig.path);};
      var figures = $List$Nonempty.dedup(A2($List$Nonempty.map,
      function (_p16) {
         return $List$Nonempty.dedup(function (figs) {
            return noPath($List$Nonempty.head(figs)) ? $List$Nonempty.pop(figs) : figs;
         }(function (_) {    return _.figures;}(_p16)));
      },
      A2(evalScan,state0(_p15.seed),m)));
      var current = A2($Signal.map,$List$Nonempty.head,A3($Signal.foldp,$Basics.always($List$Nonempty.pop),figures,_p15.clock));
      return A3($Signal.map2,render,_p15.dims,current);
   });
   return _elm.Turtle.Core.values = {_op: _op
                                    ,defaultDrawOptions: defaultDrawOptions
                                    ,draw: draw
                                    ,defaultAnimateOptions: defaultAnimateOptions
                                    ,animate: animate
                                    ,length: length
                                    ,depth: depth
...
Elm.Turtle = Elm.Turtle || {};
Elm.Turtle.make = function (_elm) {
   "use strict";
   _elm.Turtle = _elm.Turtle || {};
   if (_elm.Turtle.values) return _elm.Turtle.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Turtle$Core = Elm.Turtle.Core.make(_elm);
   var _op = {};
   var draw = $Turtle$Core.draw($Turtle$Core.defaultDrawOptions);
   var animate = $Turtle$Core.animate($Turtle$Core.defaultAnimateOptions);
   var withRandom = function () {
      var gen = A2($Random.$float,0,1);
      return function (f) {
         return $Turtle$Core.Randomly(function (seed) {
            var _p0 = A2($Random.generate,gen,seed);
            var x = _p0._0;
            var seed$ = _p0._1;
            return {ctor: "_Tuple2",_0: f(x),_1: seed$};
         });
      };
   }();
   var penColor = $Turtle$Core.Pen;
   var penDown = $Turtle$Core.PenDown;
   var penUp = $Turtle$Core.PenUp;
   var scale = $Turtle$Core.Scale;
   var make = $Turtle$Core.Make;
   var forward = $Turtle$Core.Forward;
   var right = $Turtle$Core.Right;
   var left = $Turtle$Core.Left;
   return _elm.Turtle.values = {_op: _op
                               ,left: left
                               ,right: right
                               ,forward: forward
                               ,make: make
...
Elm.Turtle = Elm.Turtle || {};
Elm.Turtle.Advanced = Elm.Turtle.Advanced || {};
Elm.Turtle.Advanced.make = function (_elm) {
   "use strict";
   _elm.Turtle = _elm.Turtle || {};
   _elm.Turtle.Advanced = _elm.Turtle.Advanced || {};
   if (_elm.Turtle.Advanced.values) return _elm.Turtle.Advanced.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   $Turtle$Core = Elm.Turtle.Core.make(_elm);
   var _op = {};
   var depth = $Turtle$Core.depth;
   var length = $Turtle$Core.length;
   var animateWith = $Turtle$Core.animate;
   var defaultAnimateOptions = $Turtle$Core.defaultAnimateOptions;
   var AnimateOptions = F3(function (a,b,c) {    return {seed: a,dims: b,clock: c};});
   var drawWith = $Turtle$Core.draw;
   var defaultDrawOptions = $Turtle$Core.defaultDrawOptions;
   var DrawOptions = F2(function (a,b) {    return {seed: a,dims: b};});
   var atomically = $Turtle$Core.Atomically;
   var invisibly = function (step) {    return $Turtle$Core.Make(_U.list([$Turtle$Core.PenUp,step,$Turtle$Core.PenDown]));};
   var rotated = F2(function (angle,step) {    return $Turtle$Core.Make(_U.list([$Turtle$Core.Left(angle),step,$Turtle$Core.Right(angle)]));});
   var scaled = F2(function (factor,step) {    return $Turtle$Core.Make(_U.list([$Turtle$Core.Scale(factor),step,$Turtle$Core.Scale(1 / factor)]));});
   var star = F2(function (n,m) {
      var alpha = 360 / ($Basics.toFloat(n) * (m - 1));
      var beta = m * alpha;
      return $Turtle$Core.Atomically(A2($List.repeat,
      n,
      $Turtle$Core.Make(_U.list([$Turtle$Core.Forward(50),$Turtle$Core.Right(180 - alpha),$Turtle$Core.Forward(50),$Turtle$Core.Left(180 - beta)]))));
   });
   var circle = function (r) {
      var n = 64;
      var dc = $Basics.pi * r / n;
      return $Turtle$Core.Atomically(A2($List._op["::"],
      $Turtle$Core.Forward(r),
      A2($List._op["::"],
      $Turtle$Core.Left(90),
      A2($List.repeat,n,$Turtle$Core.Make(_U.list([$Turtle$Core.Forward(dc),$Turtle$Core.Left(360 / $Basics.toFloat(n))]))))));
   };
   var ngon = function (n) {
      return $Turtle$Core.Make(A2($List.repeat,n,$Turtle$Core.Make(_U.list([$Turtle$Core.Forward(50),$Turtle$Core.Left(360 / $Basics.toFloat(n))]))));
   };
   var teleport = $Turtle$Core.Teleport;
   var rotateTo = $Turtle$Core.RotateTo;
   var randomly = $Turtle$Core.Randomly;
   var stay = $Turtle$Core.Stay;
   var back = $Turtle$Core.Back;
   return _elm.Turtle.Advanced.values = {_op: _op
                                        ,back: back
                                        ,stay: stay
                                        ,randomly: randomly
                                        ,rotateTo: rotateTo
...
Elm.LSys.make = function (_elm) {
   ...
   var action = F2(function (command,state) {
      ...
      {case "Push": return _U.update(state,{stack: A2($List._op["::"],state.position,state.stack)});
         case "Pop": return back(state);
         case "Forward": return _U.update(state,{steps: A2($Basics._op["++"],state.steps,_U.list([$Turtle.forward(10)])),position: newPose(state.position)});
         case "Left": return _U.update(state,
           {steps: A2($Basics._op["++"],state.steps,_U.list([$Turtle.left(45)])),position: A2(newDirection,state.position,45)});
